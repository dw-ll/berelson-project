                  ...
                  <ul>
                    <li>
                      ...
                      >
                        ...
                        <Modal.Body className="modal-body">
                          <img alt="" class="tree-profile-modal" src={DavidB} />
                          <h6>B.1900 D.1960</h6>
                          <p>
                    ...
                    <li>
                      ...
                      >
                        ...
                        <Modal.Body className="modal-body">
                          <img alt="" class="tree-profile-modal" src={Henry} />
                          <h6>B.1900 D.1960</h6>
                          <p>
                            Chaim (later: Henry) Baigelman was a violinist,
                            saxophonist and composer and the only one out of
                            nine musical siblings to survive the war. He was a
                            member of a family band, The Jolly Boys, which he
                            revived in post-war Germany under the name The Happy
                            Boys, playing jazz concerts for American soldiers
                            and Jewish survivors.
                          </p>
                        </Modal.Body>
                        <Modal.Footer className="modal-foot">
                      ...
                      <ul>
                        <li>
                          ...
                          >
                            ...
                            <Modal.Footer className="modal-foot">
                              <Button onClick={handleRivaOpen}>Close</Button>
                      ...
                      <ul>
                        <li>
                          ...
                          >
                            ...
                            <Modal.Footer className="modal-foot">
                              <Button onClick={handleJackClose}>Close</Button>
