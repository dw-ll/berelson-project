...
const FamilyTree = () => {
  ...
  const handleJackDarkModeOpen = () => {
    setJackDarkModeOpen(true);
  };
                              ...
                              <li>
                                ...
                                >
                                  ...
                                  <Modal.Footer className="modal-foot">
                                    <Button onClick={handleDavidClose}>
                                      Close
                                    </Button>
                                ...
                                >
                                  ...
                                  <Modal.Body className="modal-body">
                                    ...
                                    <p>
                                      ...
                                      violinist, saxophonist and composer and
                                      the only one out of nine musical siblings
                                      to survive the war. He was a member of a
                                      family band, The Jolly Boys, which he
                                      revived in post-war Germany under the name
                            ...
                            >
                              ...
                              <Modal.Body className="modal-body">
                                ...
                                <p>
                                  ...
                                  band, The Jolly Boys, which he revived in
                                  post-war Germany under the name The Happy
                                  Boys, playing jazz concerts for American
                                  soldiers and Jewish survivors.
                                </p>
                              </Modal.Body>
                              <Modal.Footer className="modal-foot">
                                <Button onClick={handleClose}>Close</Button>
