...
const slideImages = [
  `${IMGURL}Levin.Baigelman079.jpeg`,
  `${IMGURL}Levin.Baigelman080.jpeg`,
  `${IMGURL}Levin.Baigelman081.jpeg`
];
const properties = {
  duration: 5000,
    ...
    <Router>
      <Switch>
        ...
        <div class="container">
          <div class="row">
            <div class="col-6">
              <h3 className="profile_title">Levin Baigelman</h3>
              <h6>B. 1900 D. 1950</h6>
              <h6 className="profile_bio">
                Levin Baigelman was lorem ipsumdolor sit amet, consectetur
