...
const slideImages = [
  `${IMGURL}Lodz.Theatre426.jpeg`,
  `${IMGURL}Lodz.Theatre429.jpeg`
];
const properties = {
  duration: 5000,
    ...
    <Router>
      <Switch>
        ...
        <div class="container">
          <div class="row">
            <div class="col-6">
              <h3 className="profile_title">Lodz Theatre</h3>
              <h6>B. 1900 D. 1950</h6>
              <h6 className="profile_bio">
                Lodz Theatre was lorem ipsumdolor sit amet, consectetur
