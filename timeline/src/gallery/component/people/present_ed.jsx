...
const slideImages = [
  ...
  `${IMGURL}Ed.Silver092.jpeg`,
  `${IMGURL}Ed.Silver093.jpeg`,
  `${IMGURL}Ed.Silver094.jpeg`,
  `${IMGURL}Ed.Silver095.jpeg`
];
const properties = {
  duration: 5000,
    ...
    <Router>
      <Switch>
        ...
        <div class="container">
          <div class="row">
            <div class="col-6">
              <h3 className="profile_title">Ed</h3>
              <h6>B. 1900 D. 1950</h6>
              <h6 className="profile_bio">
                Ed was lorem ipsumdolor sit amet, consectetur adipiscing elit,
