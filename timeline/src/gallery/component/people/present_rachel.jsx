...
const slideImages = [
  `${IMGURL}Rachel188.jpeg`,
  `${IMGURL}Rachel189.jpeg`,
  `${IMGURL}Rachel190.jpeg`
];
const properties = {
  duration: 5000,
    ...
    <Router>
      <Switch>
        ...
        <div class="container">
          <div class="row">
            <div class="col-6">
              <h3 className="profile_title">Rachel</h3>
              <h6>B. 1900 D. 1950</h6>
              <h6 className="profile_bio">
                Rachel was lorem ipsumdolor sit amet, consectetur adipiscing
